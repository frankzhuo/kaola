...
<body>
	<fieldset style="width=95%">
		...
		<form id="iform" action="/versionStatisticsList.do">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;版本
		<select id="fullVersion"  name="fullVersion" onchange="changeName()" >
		 <c:forEach items="${versionNameList}" var="mnl" varStatus="stauts" >
		 	 <c:choose>
	              <c:when test="${mnl eq fullVersion}">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a class="last" target="mainFrame" href="<%=path%>/versionActionRankList.do?datestr=${datestr}&fullVersion=${fullVersion}&type=0">top 20的功能表和对应总使用次数</a>
		</form>
	</fieldset> 			    	
 	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
        ...
        <c:forEach items="${versionList}" var="ls" varStatus="stauts">
			...
			<c:choose>
				...
				<c:otherwise>
					<tr bgcolor="#ffffff"> 
				          ...
				          <td class="STYLE19">${ls.leyuyinUser}</td>
