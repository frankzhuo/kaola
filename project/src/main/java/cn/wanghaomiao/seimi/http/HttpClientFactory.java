...
public class HttpClientFactory {
    ...
    public static HttpClient getHttpClient(boolean flag){
    	
        return cliBuilder(10000,flag).build();
    }
    ...
    public static HttpClientBuilder cliBuilder(int timeout,boolean flag){
        HttpRequestRetryHandler retryHander = new HttpRequestRetryHandler() {
            @Override
            public boolean retryRequest(IOException exception, int executionCount, HttpContext context) {
                if (executionCount > 3) {
