...
#set mapreduce.map.java.opts= -Xms5000m -Xmx5000m;
#set mapred.child.java.opts= -XX:-UseGCOverheadLimit -Xms5000m -Xmx5000m;
#set mapred.child.java.opts=  -Xms5000m -Xmx5000m;
set mapreduce.map.java.opts=-Djava.net.preferIPv4Stack=true -Xms12000m -Xmx12000m;
...
select mer_id,           
    ...
    from (
      ...
      where  ymd>='20160701' and ymd<'20160703' and trans_amt>0 
      ---union all
