...
public class Big_String_accesslog {
...
//		System.out.println(bd.toBigInteger());
		...
		try {
			fileReader = new BufferedReader(new FileReader("E:/data/征信报表/cis/accesslog.csv"));
			fileWriter = new BufferedWriter(new FileWriter("E:/data/征信报表/cis/accesslog2.csv"));
			int i =1;
