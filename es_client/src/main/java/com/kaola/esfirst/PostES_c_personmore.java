...
public class PostES_c_personmore {
	...
	public PostES_c_personmore(){
		try {
			file = new BufferedWriter(new FileWriter("E:/data/es/c_personmore.txt", false));
			fileReader = new BufferedReader(new FileReader("E:/data/es/c_personmore_read.txt"));
		} catch (IOException e) {
	...
	public static void main(String[] args) throws Exception {
		PostES_c_personmore p= new PostES_c_personmore();
