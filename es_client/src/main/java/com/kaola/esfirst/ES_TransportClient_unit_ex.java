...
public class ES_TransportClient_unit_ex {
	...
	public static String cleanStr(String str){
	 ...
	 public static void main(String[] args) throws Exception {
		 ...
		 ES_TransportClient_unit_ex client = new ES_TransportClient_unit_ex();
	     client.init();
	     client.testScroll();
	     client.close();
...
//	                .addSort("_id", SortOrder.DESC)
	               ...
	               // .setQuery(QueryBuilders.prefixQuery("sys_time","2017-03-31"))
