...
@Crawler(name = "dianpingshanghuvaliddetail2",delay = 15)
public class DianPingShangHuValidIdDetailSpider2 extends BaseSeimiCrawler {
...
//    }
	...
	public String[] startUrls() {
		try {
			fileReader = new BufferedReader(new FileReader("/data/crawler/dianping/valid/dianpingshanghuid2.txt"));
			fileWriter = new BufferedWriter(new FileWriter("/data/crawler/dianping/valid/dianpingshanghuidDetail2.txt", true));
