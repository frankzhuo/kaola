...
public class PanjueWenshu  extends BaseSeimiCrawler {
...
/*    @Override
    ...
    public void start(Response response) {
      	//System.out.println("####"+response.getHttpResponse().getHeaders("Cookie").toString());
        ...
        String cookie1="_gscu_1241932522=503454142xrwww84; _gscbrs_1241932522=1; _gscu_1049835508=51288684fug20s14; _gscbrs_1049835508=1; yunsuo_session_verify=54037a42c304bbf5f267baa9d3bbfeae; ccpassport=db366574afb5408b1002220d41cfa140; _gsref_2116842793=http://wenshu.court.gov.cn/List/List?sorttype=1&conditions=searchWord+2+AJLX++%E6%A1%88%E4%BB%B6%E7%B1%BB%E5%9E%8B:%E6%B0%91%E4%BA%8B%E6%A1%88%E4%BB%B6; _gscu_2116842793=56969540wplf8j15; _gscs_2116842793=t57399000t1t1ni10|pv:3; _gscbrs_2116842793=1; "+cookie+" ; wzwstemplate=MTA=; wzwschallenge=V1pXU19DT05GSVJNX1BSRUZJWF9MQUJFTDEwMTY3MDM1";
    	push(new Request("http://wenshu.court.gov.cn/List/List?sorttype=1&conditions=searchWord+2+AJLX++%E6%A1%88%E4%BB%B6%E7%B1%BB%E5%9E%8B:%E6%B0%91%E4%BA%8B%E6%A1%88%E4%BB%B6","getStart").setCookies(cookie).setSkipDuplicateFilter(true));

    }
    //@Override
    public void getStart(Response response) {
    	...
    	//String cookie=response.getHttpResponse().getFirstHeader("Cookie").getValue();
        //System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%");
        try {
            ...
            for (long i=6;i<8;i++){
                ...
                push(new Request("http://wenshu.court.gov.cn/List/ListContent","getData").setHttpMethod(HttpMethod.POST).setParams(map1).setCookies(cookie).setSkipDuplicateFilter(true));
