...
@Crawler(name = "zolpad",delay=10)
public class zolpad  extends BaseSeimiCrawler {
    ...
    public String[] startUrls() {
    	try{
    		...
    		filew=new FileWriter("/data/crawler/zolpad.txt");
...
//    }
    ...
    public void start(Response response) {
        ...
        try {
            ...
            for (long i=1;i<137;i++){
                ...
                push(new Request("http://detail.zol.com.cn/tablepc/"+i+".html","getUrls").setSkipDuplicateFilter(true));
    ...
    public void getUrls(Response response){
        ...
        try {
            ...
            List<Object> urls = doc.sel("//div[@class='list-box']/div[@class='list-item clearfix']/div[@class='pro-intro']/h3/a/@href"); 
