...
/**
 * 商标爬取地址（标盾网）：http://www.chaxun9.com/search/   ,不能访问了,
 * 
 * 改称  www.shangdun.org
 */

public class BiaoDunWanSBHttpClient{
	...
	public static void main(String[] args) {
		...
		try {
			...
			fileWriter = new BufferedWriter(new FileWriter("/data/crawler/shangbiao/shangbiao.txt", true));
