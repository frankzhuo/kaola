 ...
 * 用框架代理不能用
 */
public class DianPingShangHuValidIdDetailHttpClient4{
	...
	public static void main(String[] args) {
		...
		try {
			fileReader = new BufferedReader(new FileReader("/data/crawler/dianping/valid/dianpingshanghuid4.txt"));
			fileWriter = new BufferedWriter(new FileWriter("/data/crawler/dianping/valid/dianpingshanghuidDetail4.txt", true));
